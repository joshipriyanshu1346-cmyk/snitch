  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-10 py-4 border border-gray-200 dark:border-[#2a2a2a] rounded-2xl font-semibold hover:bg-gray-50 dark:hover:bg-[#2a2a2a] transition-all flex items-center justify-center gap-2 text-gray-900 dark:text-white">
